package com.xiangxun.workorder.ui.login.edittext;
...
public class XSubButton extends FrameLayout {
    ...
    public void setViewInit(int clickBefore, int clickAfter, View... viewS) {
        mClickBefore = APP.getInstance().getString(clickBefore);
        mClickAfter = clickAfter == 0 ? mClickBefore : APP.getInstance().getString(clickAfter);
        mViewS = viewS;
        setState(STATE_NORMAL);
    }
