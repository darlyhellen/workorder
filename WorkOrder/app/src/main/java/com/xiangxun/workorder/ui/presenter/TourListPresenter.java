 ...
 * @TODO:我的工单解析类
 */
public class TourListPresenter {

    private TourListListener biz;

    private TourListListener.TourListInterface view;

    private ShowLoading loading;

    public TourListPresenter(TourListListener.TourListInterface view) {
        this.view = view;
        this.biz = new TourListListener();
        loading = new ShowLoading((TourListActivity) view);
        ...
        switch (v.getId()) {
            ...
            case R.id.title_view_right_Flipper01:
                if (patrol == 20) {
                    ...
                    ((TourListActivity) context).startActivityForResult(new Intent(context, TourActivity.class), 700);
                } else {
